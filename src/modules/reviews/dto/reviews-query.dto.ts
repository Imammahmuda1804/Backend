...
export class ReviewsQueryDto {
    ...
    @ApiPropertyOptional({ description: 'Filter by sentiment', enum: ['positive', 'negative', 'neutral'] })
    @IsOptional()
    @IsString()
    ...
    @ApiPropertyOptional({ description: 'Filter reviews from this date (ISO 8601)', example: '2024-01-01' })
    @IsOptional()
    @IsDateString()
    date_from?: string;

    @ApiPropertyOptional({ description: 'Filter reviews until this date (ISO 8601)', example: '2024-12-31' })
    @IsOptional()
    @IsDateString()
    date_to?: string;
